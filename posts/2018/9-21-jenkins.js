        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" So far in my DevOps journey I have explored ",
                "children":null
            },
            {
                "el":"a",
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" Jenkins differs from TravisCI in a few ways.  To work with Jenkins you must set up a server for it to run on.  Because of this, getting started with Jenkins is a longer process, and the learning curve is greater.  However, once you get over the initial learning curve of Jenkins, there is a much richer ecosystem that allows for extensive customization.  This is due to the emergence of user defined plugins which allow Jenkins tasks to be manipulated in ways outside of the core Jenkins developers vision. ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" While TravisCI uses YAML for task definitions, Groovy uses a user interface and Groovy scripts. Having the expressiveness of a full programming language for Jenkins tasks makes development fun! ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" The goal of short development cycles and applications that can be built, tested, and released at any time",
                "children":null
            },
            {
                "el":"sup",
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" Automated tasks are called \"jobs\" in Jenkins.  There are a number of different job types in Jenkins, the most popular being the Pipeline Job.  This job type creates Continuous Delivery pipelines using a Groovy script",
                "children":null
            },
            {
                "el":"sup",
    ...
    },
    {
        ...
        "children":[
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":", you understand my dislike for GUI configuration.  I'd much rather write code to configure my infrastructure/CD pipelines.  Writing code is more fun and allows the configuration to be checked into version control.  With code, replicating infrastructure or a Jenkins job is as simple as executing a script! ",
                "children":null
            }
        ]
    },
    ...
    },
    {
        ...
        "children":[
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":" approach.  With the Jenkins .war file, starting a Jenkins server is as simple as executing ",
                "children":null
            },
            {
                "el":"code",
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" The Jenkins Job DSL Plugin does not install by default, so it must be added under Manage Jenkins > Manage Plugins.  Once the DSL Plugin is added, we can create a seed job that is used to consume Jenkins Job DSL Scripts",
                "children":null
            },
            {
                "el":"sup",
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":".  This seed job is the only Job that needs to be created using the traditional Jenkins web interface. ",
                "children":null
            }
        ]
    },
    ...
    },
    {
        ...
        "children":[
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":" on the Groovy DSL for creating jobs, but I did my best to inline document what was happening.  I basically created a second freestyle job called ",
                "children":null
            },
            {
                "el":"code",
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":" which takes in three parameters.  With the new parameterized seed job, I can create new jobs by passing Seed_Job a Git repository containing a Job DSL script. ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" With Seed_Job all set, I created a new parameterized build with the location of one of my GitHub repositories. ",
                "children":null
            }
        ]
    },
    ...
    },
    {
        ...
        "children":[
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":".  The script finds a Jenkinsfile in the devops-prototypes repository from the master branch. This Jenkinsfile is what will execute every time the Hello_World job runs. ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" I looked at the console output from Seed_Job and saw that the new Hello_World pipeline job was created. ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" When running the Hello_World job the following Jenkinsfile will execute: ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" Jenkins pipeline scripts are written in one of two styles - scripted or declarative.  The Jenkinsfile script for Hello_World follows the scripted syntax, which follows the imperative paradigm",
                "children":null
            },
            {
                "el":"sup",
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":".  However, for simple pipelines like this either method suffices. ",
                "children":null
            }
        ]
    },
    {
        ...
        "children":[
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":".  Usually jobs are supposed to run on nodes other than master, but for a simple prototype it is okay. ",
                "children":null
            }
        ]
    },
    {
        ...
        "children":[
            ...
            },
            {
                "el":"#text",
                "attributes":null,
                "value":".  Inside each stage can be multiple steps, with each step being a command that executes.  My stage has two steps, both of which execute commands in Bash.  The first step looks at all the files accessible to the Jenkins pipeline, and the second step executes a simple script.sh file: ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" While in this example Seed_Job generated a simple “Hello World” example, it can be used to create jobs of greater complexity. ",
                "children":null
            }
        ]
    },
        ...
        "children":[
            {
                "el":"#text",
                "attributes":null,
                "value":" The job I created doesn't show the power of using Jenkins for Continuous Integration and Continuous  Development.  However, the seed jobs are building blocks to create complex jobs.  I will save my  adventure into complex Groovy pipelines for another discovery post.  All of the code for this post  is on ",
                "children":null
            },
            {
                "el":"a",
